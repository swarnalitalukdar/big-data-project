...
def q1():
	...
	plot = figure(title = 'Query 1', x_axis_label = 'Data', y_axis_label = 'Execution Time', plot_width = 700, plot_height = 400)
...
def q2():
	...
	plot = figure(title = 'Query 2', x_axis_label = 'Data', y_axis_label = 'Execution Time', plot_width = 700, plot_height = 400)
	plot.line(x, y, legend='f(x)', line_width=2)
	script, div = components(plot)
	context = {
		'timep': "Time Performance(in ms): ",
...
def q3():
	...
	plot = figure(title = 'Query 3', x_axis_label = 'Data', y_axis_label = 'Execution Time', plot_width = 700, plot_height = 400)
	plot.line(x, y, legend='f(x)', line_width=2)
	script, div = components(plot)
	context = {
		'name': "Name",
...
def q4():
	x = [100, 500, 1000, 5000, 10000, 20000, 35000, 50000, 75000, 100000]
	y = [1.97, 2.32, 7.04, 8.98, 16.09, 28.98, 32.93, 35.01, 52.95, 73.16]
	plot = figure(title = 'Query 4', x_axis_label = 'Data', y_axis_label = 'Execution Time', plot_width = 700, plot_height = 400)
	plot.line(x, y, legend='f(x)', line_width=2)
	script, div = components(plot)
	context = {
		'name': "Name",
...
def q5():
	...
	plot = figure(title = 'Query 5', x_axis_label = 'Data', y_axis_label = 'Execution Time', plot_width = 700, plot_height = 400)
	plot.line(x, y, legend='f(x)', line_width=2)
	script, div = components(plot)
	context = {
		'name': "Name",
